...
const destinations = [
    {
        image: img6,
        title: "Cancun",
        description: "Book a Cancun all-inclusive vacation package.",
    },
    {
        image: img8,
        title: "Dominican Republic",
        description:
            "Catch some rays on the Dominican Republic's gorgeous beaches.",
    },
    {
        image: img9,
        title: "Jamaica",
        description: "Visit the beaches of Jamaica.",
    },
    {
        image: img10,
        title: "Hawaii",
...
const TopVacationDestinations = () => {
    return (
        <section className="max-w-[1350px] mx-auto my-[50px] px-[25px]">
            ...
            {/* TITLE */}
            <h2 className="relative mb-[30px] text-center text-[24px] font-bold text-[rgba(5,13,41,0.65)] font-sans after:mx-auto after:mt-[8px] after:block after:h-[3px] after:w-[45px] after:bg-[#c9252c] after:content-['']">
